...
根据Java开源微服务博客--[蘑菇博客](http://gitee.com/moxi159753/mogu_blog_v2)改编的一个golang简化版分支，实现了大部分基础功能，前端后数据库基本上没有改动，可以直接使用蘑菇博客原版的前端和数据库脚本。目前尚存在一些问题，后续将陆续完善。争取成为国内一个较为优秀的golang博客和内容管理系统。基本框架才用简单易用的beego，orm框架采用国内广泛采用的gorm

目前仅有我一人维护，希望有兴趣的小伙伴能加入一起开发。可以联系我QQ：167843232，加我请注明蘑菇博客GO
